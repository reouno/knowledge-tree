...
SECRET_KEY = 'django-insecure-d7(6mr^1g6vfq7x$jaczqkvxbdffx3&2^=ymmv8=33=rl%!&-v'
...
INSTALLED_APPS = [
    ...
    'api_server.apps.chat',
    'api_server.apps.health_check',
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '[{asctime}: {levelname} {pathname} F:{funcName}:L{lineno}] {message}',
            'style': '{',
        },
    },
    'handlers': {
